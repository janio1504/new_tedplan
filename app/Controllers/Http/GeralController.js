  ...
  async store({ request }){
    ...
    try {
      if(!dados.id_geral_da_ae_dh){
        ...
        console.log(dados.OP001_2);
        console.log(dados.OP001_3);
        await Geral.query()
        .table('tedplan.geral_da_ae_dh')
        .where("id_geral_da_ae_dh", dados.id_geral_da_ae_dh)
        .update({
          ...
          op001_1: dados.OP001_1 ? dados.OP001_1 : false,
          op001_2: dados.OP001_2 ? dados.OP001_2 : false,
          op001_3: dados.OP001_3 ? dados.OP001_3 : false,
          op001a: dados.OP001A ? dados.OP001A : ge.op001a ,
          ri001_1: dados.RI001_1 ? dados.RI001_1 : false,
          ri001_2: dados.RI001_2 ? dados.RI001_2 : false,
          ri001_3: dados.RI001_3 ? dados.RI001_3 : false,
          ri001a: dados.RI001A ? dados.RI001A : ge.ri001a ,
          ri002_1: dados.RI002_1 ? dados.RI002_1 : false,
          ri002_2: dados.RI002_2 ? dados.RI002_2 : false,
          ri002_3: dados.RI002_3 ? dados.RI002_3 : false,
          ri002a: dados.RI002A ? dados.RI002A : ge.ri002a ,
          ri003_1: dados.RI003_1 ? dados.RI003_1 : false,
          ri003_2: dados.RI003_2 ? dados.RI003_2 : false,
          ri003_3: dados.RI003_3 ? dados.RI003_3 : false,
          ri003a: dados.RI003A ? dados.RI003A : ge.ri003a ,
          ri004_1: dados.RI004_1 ? dados.RI004_1 : false,
          ri004_2: dados.RI004_2 ? dados.RI004_2 : false,
          ri004_3: dados.RI004_3 ? dados.RI004_3 : false,
