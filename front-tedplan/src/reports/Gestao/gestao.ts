...
export function gestaoPDF(dadosMunicipio: any){
    ...
    const content: any = [
       {text: 'Dados do Município', bold: true,fontSize: 14, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
       ...
       {text: 'Titular dos Serviços Municipais de Saneamento', bold: true, fontSize: 14, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
       ...
       {text: 'Prestadores do Serviço de Saneamento Básico', bold: true,fontSize: 14, margin: [0, 10, 15, 0]},
       {text: 'Abastecimento de Água', bold: true,fontSize: 12, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
       ...
       {text: 'Esgotamento Sanitário', bold: true,fontSize: 12, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
       ...
       {text: 'Drenagem e Àguas pluviais', bold: true,fontSize: 12, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
       ...
       {text: 'Resíduos Sólidos', bold: true,fontSize: 12, margin: [0, 10, 15, 0]},
       {
        table: {
            headerRows: 1,
            body: [
