            ...
            >
              ...
              >
                {id
                  ...
                  : "Preencha as informações para criar uma nova norma"}
              </p>
            </div>

            <form
              onSubmit={handleSubmit(handleAddNorma)}
              style={{
                display: "flex",
                flexDirection: "column",
                gap: "20px",
            ...
            >
              ...
              >
                <div>
                  ...
                  <select
                    ...
                    onBlur={(e) => {
                      (e.target as HTMLSelectElement).style.borderColor =
                        errors.id_tipo_norma ? "#e74c3c" : "#e0e0e0";
                  ...
                  {errors.id_tipo_norma &&
                    errors.id_tipo_norma.type === "required" && (
                      <span
                        style={{
                          color: "#e74c3c",
                          fontSize: "14px",
              ...
              <div>
                ...
                <select
                  ...
                  onBlur={(e) => {
                    (e.target as HTMLSelectElement).style.borderColor =
                      errors.id_escala ? "#e74c3c" : "#e0e0e0";
                    (e.target as HTMLSelectElement).style.boxShadow = "none";
                  }}
                >
