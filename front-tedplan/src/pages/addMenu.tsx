...
export default function AddMenu({ menu, eixos, modulos }: MenuProps) {
  ...
  async function handleAddMenu({ titulo, descricao, id_modulo, id_eixo }) {
    try {
      const apiClient = getAPIClient();
      ...
      <Container>
        ...
        <DivMenuTitulo>
          ...
          <ul style={{}}>
            ...
            <MenuMunicipioItem onClick={handleSimisab}>
              SIMISAB
            </MenuMunicipioItem>
          </ul>
        </DivMenuTitulo>
                ...
                >
                  ...
                  >
                    {isEditing
                      ...
                      : "Preencha as informações para criar um novo menu"}
                  </p>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onBlur={(e) => {
                        (e.target as HTMLTextAreaElement).style.borderColor =
                          errors.descricao ? "#e74c3c" : "#e0e0e0";
                        (e.target as HTMLTextAreaElement).style.boxShadow =
                          "none";
                      }}
                    />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onBlur={(e) => {
                        (e.target as HTMLSelectElement).style.borderColor =
                          errors.id_modulo ? "#e74c3c" : "#e0e0e0";
                        (e.target as HTMLSelectElement).style.boxShadow =
                          "none";
                      }}
                    >
                    ...
                    {errors.id_modulo &&
                      errors.id_modulo.type === "required" && (
                        <span
                          style={{
                            color: "#e74c3c",
                            fontSize: "14px",
