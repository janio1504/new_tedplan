...
export default function AdicionarTipoUnidade() {
  const {
    register,
    handleSubmit,
    reset,
  ...
  async function handleAddTipoUnidade({ nome_tipo_unidade, id_eixo }) {
    try {
      const apiClient = getAPIClient();
      ...
      await apiClient.post("/tipo-unidade", tipoUnidadeData);

      toast.success("Tipo de unidade cadastrado com sucesso!", {
        position: "top-right",
        autoClose: 5000,
      });
      ...
      console.error("Erro ao salvar tipo de unidade:", error);
      toast.error("Erro ao salvar tipo de unidade!", {
        position: "top-right",
        autoClose: 5000,
      });
    }
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Preencha as informações para criar um novo tipo de unidade
                </p>
              </div>

              <form
                onSubmit={handleSubmit(handleAddTipoUnidade)}
                style={{
                  display: "flex",
                  flexDirection: "column",
                  gap: "24px",
