  ...
  async function handleAddGaleria({
    ...
    try {
      ...
      if (isEditMode && galeriaId) {
        ...
        // Modo de criação
        if (!imagem || !imagem[0]) {
          toast.error("Imagem é obrigatória para criar uma nova galeria!", {
            position: "top-right",
            autoClose: 5000,
          });
          return;
      ...
      if (response.data && response.data.success) {
        ...
        const errorMsg =
          ...
          (isEditMode
            ...
            : "Erro ao cadastrar galeria");
        toast.error(errorMsg, { position: "top-right", autoClose: 5000 });
      }
    } catch (error: any) {
      console.error(
        `Erro ao ${isEditMode ? "atualizar" : "cadastrar"} galeria:`,
        error
      );
      const errorMessage =
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {isEditMode
                    ? "Edite as informações da galeria"
                    : "Preencha as informações para criar uma nova galeria"}
                </p>
              </div>

              <form
                onSubmit={handleSubmit(handleAddGaleria)}
                style={{
                  display: "flex",
                  flexDirection: "column",
                  gap: "20px",
              ...
              >
                ...
                <div>
                  ...
                  >
                    {isEditMode
                      ? "Deixe em branco para manter a imagem atual. Aceita apenas arquivos de imagem (JPG, PNG, GIF, etc.)"
