          ...
          <Form onSubmit={handleSubmit(handleCadastro)}>
            <DivForm>
              ...
              <DivFormEixo>
                <DivFormConteudo
                  active={
                    activeForm === "municipiosAtendidos" ||
                    activeForm === "sedesAtendidas" ||
                    activeForm === "populacoesAtendidas" ||
                    activeForm === "populacaoExistente" ||
                    activeForm === "empregados" ||
                    activeForm === "observacoes" ||
                    activeForm === "geografiaUrbanismo" ||
                    activeForm === "dadosHidrograficos" ||
                    activeForm === "empregados1" ||
                    activeForm === "infraestrutura" ||
                    activeForm === "operacional" ||
                    activeForm === "gestaoDeRisco" ||
                    activeForm === "observacoes1" ||
                    activeForm === "infoGerais" ||
                    activeForm === "concessionarias" ||
                    activeForm === "populacaoAtendida1" ||
                    activeForm === "valorContratual" ||
                ...
                <DivFormConteudo active={activeForm === "municipiosAtendidos"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE05A</InputSNIS>
                        </td>
                        <td>
                          Quantidade de Municípios atendidos com abastecimento
                          de água{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE05B</InputSNIS>
                        </td>
                        <td>
                          Quantidade de Municípios atendidos com esgotamento
                          sanitário{" "}
                        </td>
                        <td>
                          <InputP>
                ...
                <DivFormConteudo active={activeForm === "sedesAtendidas"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE008</InputSNIS>
                        </td>
                        <td>
                          Quantidade de sedes atendidas com abastecimento de
                          água{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE009</InputSNIS>
                        </td>
                        <td>
                          Quantidade de sedes atendidas com esgotamento
                          sanitário
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE010</InputSNIS>
                        </td>
                        <td>
                          Quantidade de localidades atendidas com abastecimneto
                          de água
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE011</InputSNIS>
                        </td>
                        <td>
                          Quantidade de localidades atendidas com esgotamento
                          sanitário
                        </td>
                        <td>
                          <InputP>
                ...
                <DivFormConteudo active={activeForm === "populacaoExistente"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GD06A</InputSNIS>
                        </td>
                        <td>
                          População urbana residente no(s) município(s) com
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GD12A</InputSNIS>
                        </td>
                        <td>
                          População total residente no(s) município(s) com
                          abastecimento de água (Fonte: IBGE)
                        </td>
                        <td>
                          <InputP>
                            <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GD12B</InputSNIS>
                        </td>
                        <td>
                          População total residente no(s) município(s) com
                          esgotamento sanitário (Fonte: IBGE)
                        </td>
                        <td>
                          <InputP>
                            <input
                        ...
                        <td>
                          ...
                          >
                            <Tooltip>
                              ...
                              />
                              <TooltipText>
                                Insira informações sobre as comunidades
                                tradicionais, como por exemplo: condições da
                                infraestrutura e serviços de saneamento nessas
                                comunidades.
                              </TooltipText>
                            </Tooltip>
                          </Actions>
                ...
                <DivFormConteudo active={activeForm === "geografiaUrbanismo"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE001</InputSNIS>
                        </td>
                        <td>
                          Área territorial total do município (Fonte: IBGE){" "}
                        </td>
                        <td>
                          <InputP>
                            <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE002</InputSNIS>
                        </td>
                        <td>
                          Área urbana total, incluido áreas urbanas isoladas{" "}
                        </td>
                        <td>
                          <InputP>
                            <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE007</InputSNIS>
                        </td>
                        <td>
                          Quantidade total de imóveis existentes na área urbana
                          do município{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        ...
                        <td>
                          Quantidade total de domicílios urbanos existentes no
                          município{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE016</InputSNIS>
                        </td>
                        <td>
                          Município crítico em sanemento básico (Fonte: CPRM){" "}
                        </td>
                        <td>
                          <InputP>
                            <select
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Região hidrográfica em que se encontra o município
                          (Fonte: ANA)
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        ...
                        <td>
                          Nome da(s) bacia(s) hidrográfica(s) a que pertence o
                          município (Fonte: ANA){" "}
                        </td>
                        <td>
                          <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE012</InputSNIS>
                        </td>
                        <td>
                          Existe comitê de bacia ou sub-bacia hidrográfica
                          organizada?
                        </td>
                        <td>
                          <InputP>
                            <select {...register("GE012")}>
                              <option value="">
                                {dadosGeral?.ge012
                                  ? dadosGeral?.ge012
                                  : "Opções"}
                ...
                <DivFormConteudo active={activeForm === "infraestrutura"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>IE001</InputSNIS>
                        </td>
                        <td>
                          Existe Plano Diretor de Drenagem e Manejo das Água
                          Pluviais Urbanas?{" "}
                        </td>
                        <td>
                          <InputP>
                            <select {...register("IE001")}>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>IE013</InputSNIS>
                        </td>
                        <td>
                          Existe projeto básico, executivo ou "as built" de
                        ...
                        <td>
                          <InputP>
                            <select
                              ...
                              onChange={handleOnChange}
                            >
                              <option value="Unitário(misto com esgotamento sanitário)">
                                Unitário (misto com esgotamento sanitário)
                              </option>
                              <option value="Exclusivo para drenagem">
                                Exclusivo para drenagem
                              </option>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>IE016A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é o outro tipo de sistema de drenagem
                          Urbana
                        </td>
                        <td colSpan={4}>
                          <input
                ...
                <DivFormConteudo active={activeForm === "operacional"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>OP001</InputSNIS>
                        </td>
                        <td>
                          Quais da seguintes intervenções ou manutenções foram
                          realizadas?
                        </td>
                        <td>
                          <DivChekbox>
                            <CheckBox>
                              ...
                              />
                              <span>Não houve intervenção ou manutenção</span>
                            </CheckBox>
                            <CheckBox>
                              <input
                                {...register("OP001_2")}
                                ...
                                type="checkbox"
                              />
                              <span>Manutenção ou recuperação de sarjetas</span>
                            </CheckBox>
                            <CheckBox>
                              <input
                                {...register("OP001_3")}
                                ...
                                type="checkbox"
                              />
                              <span>Manutenção ou recuperação estrutural</span>
                            </CheckBox>
                          </DivChekbox>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <InputSNIS>OP001A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é a outra intervenção ou manutenção
                        </td>
                        <td colSpan={4}>
                          <input
                            {...register("OP001A")}
                ...
                <DivFormConteudo active={activeForm === "gestaoDeRisco"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI001</InputSNIS>
                        </td>
                        <td>
                          Indique quais das seguintes instituições existem
                        </td>
                        <td>
                          <DivChekbox>
                            <CheckBox>
                              ...
                              />
                              <span>
                                Não há instituições relacionadas com a gestão de
                                riscos ou respostas a desastres
                              </span>
                            </CheckBox>
                            <CheckBox>
                              <input
                                ...
                                type="checkbox"
                              />
                              <span>Unidades de corpos de bombeiros</span>
                            </CheckBox>
                            <CheckBox>
                              <input
                                {...register("RI001_3")}
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI001A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é a outra instituição que atua na
                          prevenção
                        </td>
                        <td colSpan={4}>
                          <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI002</InputSNIS>
                        </td>
                        <td>
                          Quais da intervenções ou situações a seguir existem na
                          área rural a montante das áreas urbanas?
                        </td>
                        <td>
                          <DivChekbox>
                            <CheckBox>
                              <input
                                ...
                                type="checkbox"
                              />
                              <span>Nenhuma intervenção ou situação</span>
                            </CheckBox>
                            <CheckBox>
                              <input
                                {...register("RI002_2")}
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI002A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é a outra intervenção com potencial
                          de risco
                        </td>
                        <td colSpan={4}>
                          <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI003</InputSNIS>
                        </td>
                        <td>
                          Instrumento de controle e monitoramento hidrológicos
                          existentes
                        </td>
                        <td>
                          <DivChekbox>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI003A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é o outro instrumento de controle de
                          monitoramento
                        </td>
                        <td colSpan={4}>
                          <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI004</InputSNIS>
                        </td>
                        <td>
                          Dados hidrológicos monitorados e metodologia de
                          monitoramento
                        </td>
                        <td>
                          <DivChekbox>
                            <CheckBox>
                              ...
                              />
                              <span>
                                Quantidade de chuva por registro auto..
                              </span>
                            </CheckBox>
                            <CheckBox>
                              <input
                              ...
                              />
                              <span>
                                Quantidade de chuva por frequência diária
                              </span>
                            </CheckBox>
                            <CheckBox>
                              <input
                              ...
                              />
                              <span>
                                Quantidade de chuva por frequência hora..
                              </span>
                            </CheckBox>
                          </DivChekbox>
                        </td>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI004A</InputSNIS>
                        </td>
                        <td>
                          Especifique qual é o outro dado hidrológico monitorado
                        </td>
                        <td colSpan={4}>
                          <input
                            {...register("RI004A")}
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI005</InputSNIS>
                        </td>
                        <td>
                          Existem sistemas de alerta de riscos hidrológicos
                          (alagamentos, enxurradas, inundaçoẽs)?{" "}
                        </td>
                        <td>
                          <InputP>
                            <select
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI007</InputSNIS>
                        </td>
                        <td>
                          Existe cadastro ou demarcação de marcas históricas de
                          inundações?{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI009</InputSNIS>
                        </td>
                        <td>
                          Existe mapeamento de áreas de risco de inundações dos
                          cursos d'água urbana?{" "}
                        </td>
                        <td>
                          <InputP>
                            <select
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI011</InputSNIS>
                        </td>
                        <td>
                          Qual percentual de área total do município está
                          mapeada?{" "}
                        </td>
                        <td>
                          <InputP>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        <td>
                          <InputSNIS>RI012</InputSNIS>
                        </td>
                        <td>
                          Tempo de recorrência (ou periodo de retorno) adotado
                          para o mapeamento
                        </td>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>RI013</InputSNIS>
                        </td>
                        <td>
                          Quantidade docmicílios sujeitos a risco de inundação
                        </td>
                        <td colSpan={4}>
                          <input
                            {...register("RI013")}
                ...
                <DivFormConteudo active={activeForm === "infoGerais"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE201</InputSNIS>
                        </td>
                        <td>
                          O oŕgão (Prestador) é também o prestador - direto ou
                          indireto - de outros serviços de Saneamento?
                        </td>
                        <td>
                          <InputP>
                            <select
                            ...
                            >
                              ...
                              <option value="Não">Não</option>
                              <option value="Abastecimento de água potável">
                                Abastecimento de água potável
                              </option>
                              <option value="Esgotamento Sanitário">
                                Esgotamento Sanitário
                              </option>
                              <option value="Abastecimento de água potável e Esgotamento Sanitário">
                                Abastecimento de água potável e Esgotamento
                                Sanitário
                              </option>
                              <option value="Drenagem e manejo de águas pluviais">
                                Drenagem e manejo de águas pluviais
                              </option>
                              <option value="Abast. água potável e Drenagem e manejo de águas pluviais">
                                Abast. água potável e Drenagem e manejo de águas
                                pluviais
                              </option>
                              <option value="Esgot. Sanitário e Drenagem e manejo de águas pluviais">
                                Esgot. Sanitário e Drenagem e manejo de águas
                                pluviais
                              </option>
                              <option value="Abast. água potável, Esgot. Sanitário e Drenagem e manejo de águas pluviais">
                                Abast. água potável, Esgot. Sanitário e Drenagem
                ...
                <DivFormConteudo active={activeForm === "concessionarias"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>GE202</InputSNIS>
                        </td>
                        <td>
                          Há empresa com contrato de DELEGAÇÂO (conceção ou
                          contrato de programa) para algum ou todos os serviços
                          de limpeza urbana?
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        ...
                        <td>
                          <BotaoAdicionar
                            onClick={() => handleModalAddConcesionaria()}
                          >
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Quantidade de docmicílios sujeitos a risco de
                          inundação
                        </td>
                        <td colSpan={4}>
                          <input
                ...
                <DivFormConteudo active={activeForm === "populacaoAtendida1"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO050</InputSNIS>
                        </td>
                        <td>
                          População urbana atendida no município, abrangendo
                          sede e localidades
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO165</InputSNIS>
                        </td>
                        <td>
                          População urbana atendida pelo serviço de coleta
                          domiciliar direta, ou seja, porta a porta{" "}
                        </td>
                        <td>
                          <InputP>
                            <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO147</InputSNIS>
                        </td>
                        <td>
                          População rural atendida com serviço de coleta
                          domiciliar
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO135</InputSNIS>
                        </td>
                        <td>
                          Percentual da população atendida com frequência de 2 a
                          3 vezes por semana{" "}
                        </td>
                        <td>
                          <InputP>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CS050</InputSNIS>
                        </td>
                        <td>
                          Percentual da população atendida com a COLETA SELETIVA
                          de porta a porta{" "}
                        </td>
                        <td>
                          <InputP>
                ...
                <DivFormConteudo active={activeForm === "valorContratual"}>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO162</InputSNIS>
                        </td>
                        <td>
                          Valor contratual (Preço unitário) do serviço de
                          aterramento de RDO e RDU
                        </td>
                        <td>
                          <InputP>
                            <input
                      ...
                      <tr>
                        <td>
                          <InputSNIS>CO178</InputSNIS>
                        </td>
                        <td>
                          Valor contratual (Preço unitário) do serviço de coleta
                          e transporte e destinação final de RDO e RPU
                        </td>
                        <td>
                          <InputP>
                            <input
        ...
        {modalAddConssionaria && (
          <ContainerModal>
            <ModalForm>
              <DivFormResiduo>
                <DivTituloFormResiduo>
                  Edição de cadastro de Concessionária
                </DivTituloFormResiduo>
                      ...
                      <table>
                        ...
                        <tbody>
                          <input
                            ...
                            defaultValue={
                              dadosConcessionaria?.id_concessionaria
                            }
                          ></input>
                          <tr>
                            <td>
                              <InputGG>CNPJ da Concessionária</InputGG>
                            </td>
                            <td>
                              <InputP>
                                <input
                          ...
                          <tr>
                            <td>
                              <InputGG>Razão Social Concessionária</InputGG>
                            </td>
                            <td>
                              <InputP>
                                <input
                                  ...
                                  defaultValue={
                                    dadosConcessionaria?.razao_social
                                  }
                                  onChange={handleOnChange}
                                ></input>
                              </InputP>
                          ...
                          <tr>
                            <td>
                              <InputGG>Duração(em anos)</InputGG>
                            </td>
                            <td>
                              <InputP>
                                <input
                          ...
                          <tr>
                            ...
                            <td>
                              <DivChekbox>
                                <CheckBox>
                                  <input
                                    {...register("capina_e_rocada")}
                                    defaultChecked={
                                      dadosConcessionaria?.capina_e_rocada
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Capina e roçada</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("coleta_res_construcao_civil")}
                                    defaultChecked={
                                      dadosConcessionaria?.coleta_res_construcao_civil
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Coleta de res. contrucão civil</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("coteta_res_domiciliar")}
                                    defaultChecked={
                                      dadosConcessionaria?.coteta_res_domiciliar
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Coleta de res. Domiciliar</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("coleta_res_servicos_saude")}
                                    defaultChecked={
                                      dadosConcessionaria?.coleta_res_servicos_saude
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                ...
                                <CheckBox>
                                  <input
                                    {...register("coleta_res_publico")}
                                    defaultChecked={
                                      dadosConcessionaria?.coleta_res_publico
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Coleta de res. Público</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("operacao_aterro_sanitario")}
                                    defaultChecked={
                                      dadosConcessionaria?.operacao_aterro_sanitario
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Operação de aterro sanitário</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("operacao_incinerador")}
                                    defaultChecked={
                                      dadosConcessionaria?.operacao_incinerador
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Operação de incinerador</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register(
                                      "operacao_outras_unidades_processamento"
                                    )}
                                    defaultChecked={
                                      dadosConcessionaria?.operacao_outras_unidades_processamento
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                ...
                                <CheckBox>
                                  <input
                                    {...register(
                                      "operacao_unidade_compostagem"
                                    )}
                                    defaultChecked={
                                      dadosConcessionaria?.operacao_unidade_compostagem
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                ...
                                <CheckBox>
                                  <input
                                    {...register("operacao_triagem")}
                                    defaultChecked={
                                      dadosConcessionaria?.operacao_triagem
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Operação de triagem</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register("outros")}
                                ...
                                <CheckBox>
                                  <input
                                    {...register("tipo_desconhecido")}
                                    defaultChecked={
                                      dadosConcessionaria?.tipo_desconhecido
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Tipo desconhecido</span>
                                </CheckBox>
                                <CheckBox>
                                  <input
                                    {...register(
                                      "varricao_logradouros_publicos"
                                    )}
                                    defaultChecked={
                                      dadosConcessionaria?.varricao_logradouros_publicos
                                    }
                                    onChange={handleOnChange}
                                    type="checkbox"
                                  />
                                  <span>Varrição de logradouros públicos</span>
                                </CheckBox>
                              </DivChekbox>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <InputGG>Unidade relacionada</InputGG>
                            </td>
                            <td>
                              <InputP>
                                <select
                                  {...register("unidade_relacionada")}
                                  defaultValue={
                                    dadosConcessionaria?.unidade_relacionada
                                  }
                                  onChange={handleOnChange}
                                >
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Percentual da população atendida com frequência
                            diária
                          </td>
                          <td>
                            <InputP>
                        ...
                        <tr>
                          ...
                          <td>
                            Percentual da população atendida com a COLETA
                            SELETIVA de porta a porta{" "}
                          </td>
                          <td>
                            <InputP>
                              <input
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Valor contratual (Preço unitário) do serviço de
                            coleta e transporte e destinação final de RDO e RPU
                          </td>
                          <td>
                            <InputP>
                              <input
