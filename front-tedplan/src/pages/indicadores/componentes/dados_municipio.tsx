      ...
      <MainContent>
        ...
        <Form onSubmit={handleSubmit(handleCadastro)}>
            ...
            <DivFormCadastro active={activeForm === 'titularServicos'}>
              <DivTituloForm>Titular dos Serviços Municipais de Saneamento</DivTituloForm>
              <input
            ...
            <DivFormCadastro active={activeForm === 'reguladorFiscalizador'}>
              <DivTituloForm>Regulador e Fiscalizador dos Serviços de Saneamento</DivTituloForm>
              <input
