...
export default function PrestacaoServicoEsgoto() {
  ...
  async function getMenus() {
    const res = await api.get("menus/eixo/" + 3).then((response) => {
  ...
  async function loadUnidades() {
    ...
    try {
      ...
      const response = await apiClient.get("/unidades/eixo/3");
  ...
  async function loadTiposUnidade(idEixo: number = 3) {
    try {
      const apiClient = getAPIClient();
  ...
  function handleEditUnidade(unidade: IUnidade) {
    ...
    const eixoId = unidade.id_eixo || 3;
    ...
    setValueUnidade("id_eixo", unidade.id_eixo?.toString() || "3");
  ...
  async function handleSaveUnidade(data: any) {
    try {
      ...
      const unidadeData = {
        ...
        id_eixo: parseToIntOrNull(data.id_eixo) || 3,
            ...
            <ConteudoModal>
              <form onSubmit={handleSubmitUnidade(handleSaveUnidade)}>
                ...
                >
                  ...
                  <input
                    {...registerUnidade("id_eixo", { value: "3" })}
                    type="text"
                    disabled
                    value={eixos.find((e) => e.id_eixo === 3)?.nome || "Eixo 3"}
                    style={{
                      margin: "0 auto",
                      width: "90%",
                      padding: "12px 15px",
