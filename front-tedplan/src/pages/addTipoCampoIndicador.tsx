...
export default function AddTipoCampoIndicador({ tipoCampo }: TipoCampoProps) {
  ...
  async function loadTipoCampoData(id: string) {
    try {
      ...
      toast.error("Erro ao carregar dados do tipo de campo!", {
        position: "top-right",
        autoClose: 5000,
      });
    }
  ...
  async function handleAddTipoCampo(data) {
    try {
      ...
      if (isEditing && tipoCampoId) {
        ...
        toast.success("Tipo de campo atualizado com sucesso!", {
          position: "top-right",
          autoClose: 5000,
        });
      } else {
        ...
        toast.success("Tipo de campo cadastrado com sucesso!", {
          position: "top-right",
          autoClose: 5000,
        });
      }
      ...
      <BodyDashboard>
        ...
        <div
            ...
            >
              ...
              >
                {isEditing
                  ? "Atualize as informações do tipo de campo"
                  : "Preencha as informações para criar um novo tipo de campo"}
              </p>
            </div>

            <form
              onSubmit={handleSubmit(handleAddTipoCampo)}
              style={{
                display: "flex",
                flexDirection: "column",
                gap: "20px",
            ...
            >
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => {
                    (e.target as HTMLInputElement).style.borderColor =
                      errors.name_campo ? "#e74c3c" : "#e0e0e0";
