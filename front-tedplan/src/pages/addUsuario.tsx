      ...
      <BodyDashboard>
        ...
        <div
          ...
          >
            ...
            <form
              onSubmit={handleSubmit(handleAddUsuario)}
              style={{
                display: "flex",
                flexDirection: "column",
                gap: "20px",
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  onBlur={(e) => {
                    (e.target as HTMLSelectElement).style.borderColor =
                      errors.id_sistema ? "#e74c3c" : "#e0e0e0";
